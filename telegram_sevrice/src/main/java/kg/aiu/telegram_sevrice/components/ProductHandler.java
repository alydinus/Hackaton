...
//
//    public ProductHandler(TelServiceClient telService, TelegramBot bot) {
//        this.telService = telService;
//        this.bot = bot;
//    }
//
//    public void handleProductsCommand(Long chatId) {
...
//    }
//
//    public void showProductsList(Long chatId, int page) {
//        try {
//            List<Product> products = telService.getAllProducts();
//
//            if (products.isEmpty()) {
...
//            }
//
//            InlineKeyboardMarkup keyboard = createProductsPaginationKeyboard(page, totalPages);
...
//    }
//
//    public void showProductDetails(Long chatId, Long productId) {
//        try {
//            Product product = telService.getProductById(productId);
//
...
//    }
//
//    public void startProductCreation(Long chatId, TelSessionModel session) {
...
//    }
//
//    public void processProductCreation(Long chatId, String text, TelSessionModel session) {
...
//                completeProductCreation(chatId, session);
//                break;
//        }
//    }
//
//    public void completeProductCreation(Long chatId, TelSessionModel session) {
//        try {
//            Map<String, Object> context = session.getContext();
//
...
//
//            Product createdProduct = telService.createProduct(product);
//
//            String message = String.format(
...
//                    createdProduct.getStockQuantity(), createdProduct.getCategory()
//            );
//
...
//        try {
//            telService.deleteProduct(productId);
...
//    }
//
//    public void searchProducts(Long chatId, String query) {
//        try {
//            List<Product> products = telService.searchProducts(query);
//
//            if (products.isEmpty()) {
...
//    }
//
//    private InlineKeyboardMarkup createProductsPaginationKeyboard(int currentPage, int totalPages) {
//        InlineKeyboardMarkup keyboard = new InlineKeyboardMarkup();
//        List<List<InlineKeyboardButton>> rows = new ArrayList<>();
//
